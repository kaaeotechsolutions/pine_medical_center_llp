        ...
        <Flex flexDirection={{ base: "column", md: "row" }} gap={{md:12, lg:24}} alignItems="center" justify="center">
          ...
          <Stack mr={{ base: 2, md: 4 }} color="gray.50" _hover={{color:'gray.600'}} spacing={4} direction="row" alignItems="center">
            <Link href="/aboutus" target="_blank">
              <IconButton fontSize={{ base: "xl", md: "2xl" }} aria-label="Facebook" icon={<FaFacebook />} variant="ghost" />
            </Link>
            <Link href="/aboutus" target="_blank">
              <IconButton fontSize={{ base: "xl", md: "2xl" }} aria-label="Twitter" icon={<FaTwitter />} variant="ghost" />
            </Link>
            <Link href="/aboutus" target="_blank">
              <IconButton fontSize={{ base: "xl", md: "2xl" }} aria-label="Instagram" icon={<FaInstagram />} variant="ghost" />
            </Link>
            <Link href="/aboutus" target="_blank">
              <IconButton fontSize={{ base: "xl", md: "2xl" }} aria-label="YouTube" icon={<FaYoutube />} variant="ghost" />
            </Link>
            <Link href="/aboutus" target="_blank">
              <IconButton fontSize={{ base: "xl", md: "2xl" }} aria-label="Email" icon={<FaEnvelope />} variant="ghost" />
            </Link>
          </Stack>
        </Flex>
